---
name: cheezy-development-guidelines
description: Use when writing ANY code in this project (this Phoenix/Elixir lms application). Invoke BEFORE implementing features, fixing bugs, or making UI changes. Invoke BEFORE marking any development task as complete.
---

# Cheezy Development Guidelines
